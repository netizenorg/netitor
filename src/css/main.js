...
:root {
  ...
  --light-bracket: #aa9595;
  --light-comment: #d3c8c8;
  --light-gray: #7E7E7F;
}
...
.cm-s-light div.CodeMirror-cursor {
  width: 1px;
  border-left: 2px solid var(--light-bracket);
}
...
/* all blue */
.cm-s-light .cm-variable.cm-callee {
  color: var(--netizen-blue);
}
.cm-s-light .cm-variable-2 {
  color: var(--netizen-blue);
}
...
.cm-s-light .CodeMirror-matchingbracket {
  color: var(--light-bracket) !important;
}
.cm-s-light .CodeMirror-matchingbracket, .CodeMirror-matchingtag {
  padding-bottom: 3px;
  color: var(--light-bracket);
  border-bottom: 2px solid var(--light-comment) !important;
}
